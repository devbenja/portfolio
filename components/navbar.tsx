...
export const NavBar = () => {
    return (
        <nav className="fixed z-20 flex flex-row items-center justify-center mt-auto h-max w-full bottom-8 lg:flex-row lg:items-center lg:justify-start lg:h-full lg:bottom-0 lg:pl-10">
